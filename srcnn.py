...
def load_matlab_data(train_dir, colour_format):
    if colour_format == 'ych':
        train_dir = train_dir + '/MATLAB/train_91_ychannels_matlab.h5'
    elif colour_format == 'ycbcr':
        train_dir = train_dir + '/MATLAB/train_91_ycbcrchannels_matlab.h5'
    elif colour_format == 'rgb':
        train_dir = train_dir + '/MATLAB/train_91_rgbchannels_matlab.h5'
...
def load_octave_data(train_dir, colour_format):
    if colour_format == 'ych':
        train_dir = train_dir + '/Octave/train_91_ychannels_octave.h5'
    elif colour_format == 'ycbcr':
        train_dir = train_dir + '/Octave/train_91_ycbcrchannels_octave.h5'
    elif colour_format == 'rgb':
        train_dir = train_dir + '/Octave/train_91_rgbchannels_octave.h5'
    with h5py.File(train_dir, 'r') as f:
