...
base_savepath_3x = '/RGB2YCBCR_MATLAB/91_3x_mat_ycbcr';
base_savepath_4x = '/RGB2YCBCR_MATLAB/91_4x_mat_ycbcr';
...
base_savepath_2x_upscaled = '/RGB2YCBCR_MATLAB/91_2x_upscaled_mat_ycbcr';
base_savepath_3x_upscaled = '/RGB2YCBCR_MATLAB/91_3x_upscaled_mat_ycbcr';
base_savepath_4x_upscaled = '/RGB2YCBCR_MATLAB/91_4x_upscaled_mat_ycbcr';
...
for i = 1:length(filepath)
    ...
    img_clr = img_ycbcr(:, :, 2:3);
    img_y = img_ycbcr(:, :, 1);
    
    [h1, w1] = size(img_y);
    
    name_gt = sprintf('%s/%s', savepath_gt, file_name);
    imwrite(img_ycbcr, name_gt);
